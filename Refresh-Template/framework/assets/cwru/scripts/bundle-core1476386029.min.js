...
!function(e){"use strict";e.fn.fitVids=function(i){var t={customSelector:null,ignore:null};if(!document.getElementById("fit-vids-style")){var r=document.head||document.getElementsByTagName("head")[0],a=".fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}",c=document.createElement("div");c.innerHTML='<p>x</p><style id="fit-vids-style">'+a+"</style>",r.appendChild(c.childNodes[1])}return i&&e.extend(t,i),this.each(function(){var i=['iframe[src*="player.vimeo.com"]','iframe[src*="youtube.com"]','iframe[src*="youtube-nocookie.com"]','iframe[src*="kickstarter.com"][src*="video.html"]','iframe[src*="funnyordie.com"]','iframe[src*="media.mtvnservices.com"]','iframe[src*="trailers.apple.com"]','iframe[src*="viddler.com"]','iframe[src*="brightcove.com"]','iframe[src*="link.brightcove.com"]','iframe[src*="makerplayer.com"]','iframe[src*="break.com"]','iframe[src*="traileraddict.com"]','iframe[src*="d.yimg.com"]','iframe[src*="movies.yahoo.com"]','iframe[src*="dailymotion.com"]','iframe[src*="s.mcstatic.com"]','iframe[src*="fast.wistia.net"]','iframe[src*="hulu.com"]','iframe[src*="vine.co"]','iframe[src*="videopress.com"]','iframe[src*="vid.me"]','iframe[src*="player.twitch.tv"]','iframe[src*="livestream.com"]','iframe[src*="new.livestream.com"]','iframe[src*="ustream.tv"]','iframe[src*="facebook.com"]','iframe[src*="cache.vevo.com"]',"object","embed"];t.customSelector&&i.push(t.customSelector);var r=".fitvidsignore";t.ignore&&(r=r+", "+t.ignore);var a=e(this).find(i.join(","));a=a.not("object object"),a=a.not(r),a.each(function(){var i=e(this);if(!(i.parents(r).length>0||"embed"===this.tagName.toLowerCase()&&i.parent("object").length||i.parent(".fluid-width-video-wrapper").length)){i.css("height")||i.css("width")||!isNaN(i.attr("height"))&&!isNaN(i.attr("width"))||(i.attr("height",9),i.attr("width",16));var t="object"===this.tagName.toLowerCase()||i.attr("height")&&!isNaN(parseInt(i.attr("height"),10))?parseInt(i.attr("height"),10):i.height(),a=isNaN(parseInt(i.attr("width"),10))?i.width():parseInt(i.attr("width"),10),c=t/a;if(!i.attr("name")){var o="fitvid"+e.fn.fitVids._count;i.attr("name",o),e.fn.fitVids._count++}i.wrap('<div class="fluid-width-video-wrapper"></div>').parent(".fluid-width-video-wrapper").css("padding-top",100*c+"%"),i.removeAttr("height").removeAttr("width")}})})},e.fn.fitVids._count=0}(window.jQuery||window.Zepto);
...
!function(t){"use strict";var e=function(e,n,i,o){this.target=e,this.url=n,this.html=[],this.effectQueue=[],this.options=t.extend({ssl:!0,host:"www.feedrapp.info",limit:null,key:null,layoutTemplate:"<ul>{entries}</ul>",entryTemplate:'<li><a href="{url}" target="_blank" class="feed-container-title">{title}</a><div class="feed-container-date">{date}</div></li>',tokens:{img:function(t,e){return t.thumbnail},excerptBody250:function(t,e){return e.body.slice(0,250)+"..."},excerptBody200:function(t,e){return e.body.slice(0,200)+"..."},excerptBody150:function(t,e){return e.body.slice(0,150)+"..."},excerptBody100:function(t,e){return e.body.slice(0,100)+"..."}},outputMode:"json",dateFormat:"MM/DD/YYYY",dateLocale:"en",effect:"show",offsetStart:null,offsetEnd:null,error:function(){console.log("jQuery RSS: url doesn't link to RSS-Feed")},onData:function(){},success:function(){}},i||{}),this.options.ssl&&"www.feedrapp.info"===this.options.host&&(this.options.host="feedrapp.herokuapp.com"),this.callback=o||this.options.success};e.htmlTags=["doctype","html","head","title","base","link","meta","style","script","noscript","body","article","nav","aside","section","header","footer","h1-h6","hgroup","address","p","hr","pre","blockquote","ol","ul","li","dl","dt","dd","figure","figcaption","div","table","caption","thead","tbody","tfoot","tr","th","td","col","colgroup","form","fieldset","legend","label","input","button","select","datalist","optgroup","option","textarea","keygen","output","progress","meter","details","summary","command","menu","del","ins","img","iframe","embed","object","param","video","audio","source","canvas","track","map","area","a","em","strong","i","b","u","s","small","abbr","q","cite","dfn","sub","sup","time","code","kbd","samp","var","mark","bdi","bdo","ruby","rt","rp","span","br","wbr"],e.prototype.load=function(e){var n="http"+(this.options.ssl?"s":""),i=n+"://"+this.options.host,o=i+"?callback=?&q="+encodeURIComponent(this.url);this.options.offsetStart&&this.options.offsetEnd&&(this.options.limit=this.options.offsetEnd),null!==this.options.limit&&(o+="&num="+this.options.limit),null!==this.options.key&&(o+="&key="+this.options.key),t.getJSON(o,e)},e.prototype.render=function(){function e(i){window.setTimeout(function(){t(i).length?n(i):e(i)},50)}function n(e){t(e).find("li.search-item").each(function(){""==t(this).find("a>img").attr("src")&&(t(this).find("a>img").css("display","none"),t(this).find("div").css("padding-left","0px"))})}function i(e){window.setTimeout(function(){t(e).length?o(e):i(e)},50)}function o(e){t(e).find("div.thumbnail").each(function(){""==t(this).find("a>img").attr("src")&&(t(this).find("a>img").css("display","none"),t(this).find(">div h2").css("margin-top","0px"))})}var r=this;this.load(function(e){try{r.feed=e.responseData.feed,r.entries=e.responseData.feed.entries}catch(n){return r.entries=[],r.feed=null,r.options.error.call(r)}var i=r.generateHTMLForEntries();if(r.target.append(i.layout),0!==i.entries.length){t.isFunction(r.options.onData)&&r.options.onData.call(r);var o=t(i.layout).is("entries")?i.layout:t("entries",i.layout);r.appendEntriesAndApplyEffects(o,i.entries)}r.effectQueue.length>0?r.executeEffectQueue(r.callback):t.isFunction(r.callback)&&r.callback.call(r)}),e("#"+r.target.attr("id")+">ul"),i("#"+r.target.attr("id")+">div.row")},e.prototype.appendEntriesAndApplyEffects=function(e,n){var i=this;t.each(n,function(t,n){var o=i.wrapContent(n);"show"===i.options.effect?e.before(o):(o.css({display:"none"}),e.before(o),i.applyEffect(o,i.options.effect))}),e.remove()},e.prototype.generateHTMLForEntries=function(){var e=this,n={entries:[],layout:null};return t(this.entries).each(function(){var t,i=this,o=e.options.offsetStart,r=e.options.offsetEnd;o&&r?index>=o&&index<=r&&e.isRelevant(i,n.entries)&&(t=e.evaluateStringForEntry(e.options.entryTemplate,i),n.entries.push(t)):e.isRelevant(i,n.entries)&&(t=e.evaluateStringForEntry(e.options.entryTemplate,i),n.entries.push(t))}),this.options.entryTemplate?n.layout=this.wrapContent(this.options.layoutTemplate.replace("{entries}","<entries></entries>")):n.layout=this.wrapContent("<div><entries></entries></div>"),n},e.prototype.wrapContent=function(e){return t(0!==t.trim(e).indexOf("<")?"<div>"+e+"</div>":e)},e.prototype.applyEffect=function(t,e,n){var i=this;switch(e){case"slide":t.slideDown("slow",n);break;case"slideFast":t.slideDown(n);break;case"slideSynced":i.effectQueue.push({element:t,effect:"slide"});break;case"slideFastSynced":i.effectQueue.push({element:t,effect:"slideFast"})}},e.prototype.executeEffectQueue=function(t){var e=this;this.effectQueue.reverse();var n=function(){var i=e.effectQueue.pop();i?e.applyEffect(i.element,i.effect,n):t&&t()};n()},e.prototype.evaluateStringForEntry=function(e,n){var i=e,o=this;return t(e.match(/(\{.*?\})/g)).each(function(){var t=this.toString();i=i.replace(t,o.getValueForToken(t,n))}),i},e.prototype.isRelevant=function(t,e){var n=this.getTokenMap(t);return!this.options.filter||(!this.options.filterLimit||this.options.filterLimit!==e.length)&&this.options.filter(t,n)},e.prototype.getFormattedDate=function(t){if(this.options.dateFormatFunction)return this.options.dateFormatFunction(t);if("undefined"!=typeof moment){var e=moment(new Date(t));return e=e.locale?e.locale(this.options.dateLocale):e.lang(this.options.dateLocale),e.format(this.options.dateFormat)}return t},e.prototype.getTokenMap=function(n){if(!this.feedTokens){var i=JSON.parse(JSON.stringify(this.feed));delete i.entries,this.feedTokens=i}return t.extend({feed:this.feedTokens,url:n.link,author:n.author,date:this.getFormattedDate(n.publishedDate),title:n.title,body:n.content,shortBody:n.contentSnippet,excerptContent100:n.content.replace(/(<([^>]+)>)/gi,"").substring(0,100)+"...",excerptContent150:n.content.replace(/(<([^>]+)>)/gi,"").substring(0,150)+"...",excerptContent200:n.content.replace(/(<([^>]+)>)/gi,"").substring(0,200)+"...",excerptContent250:n.content.replace(/(<([^>]+)>)/gi,"").substring(0,250)+"...",bodyPlain:function(t){for(var n=t.content.replace(/<script[\\r\\\s\S]*<\/script>/gim,"").replace(/<\/?[^>]+>/gi,""),i=0;i<e.htmlTags.length;i++)n=n.replace(new RegExp("<"+e.htmlTags[i],"gi"),"");return n}(n),bodyPlain250:function(t){for(var n=t.content.replace(/<script[\\r\\\s\S]*<\/script>/gim,"").replace(/<\/?[^>]+>/gi,"").substring(0,250)+"...",i=0;i<e.htmlTags.length;i++)n=n.replace(new RegExp("<"+e.htmlTags[i],"gi"),"");return n}(n),bodyPlain200:function(t){for(var n=t.content.replace(/<script[\\r\\\s\S]*<\/script>/gim,"").replace(/<\/?[^>]+>/gi,"").substring(0,200)+"...",i=0;i<e.htmlTags.length;i++)n=n.replace(new RegExp("<"+e.htmlTags[i],"gi"),"");return n}(n),bodyPlain150:function(t){for(var n=t.content.replace(/<script[\\r\\\s\S]*<\/script>/gim,"").replace(/<\/?[^>]+>/gi,"").substring(0,150)+"...",i=0;i<e.htmlTags.length;i++)n=n.replace(new RegExp("<"+e.htmlTags[i],"gi"),"");return n}(n),bodyPlain100:function(t){for(var n=t.content.replace(/<script[\\r\\\s\S]*<\/script>/gim,"").replace(/<\/?[^>]+>/gi,"").substring(0,100)+"...",i=0;i<e.htmlTags.length;i++)n=n.replace(new RegExp("<"+e.htmlTags[i],"gi"),"");return n}(n),shortBodyPlain:n.contentSnippet.replace(/<\/?[^>]+>/gi,""),index:t.inArray(n,this.entries),totalEntries:this.entries.length,teaserImage:function(t){try{return t.content.match(/(<img.*?>)/gi)[0]}catch(e){return""}}(n),teaserImageUrl:function(t){try{return t.content.match(/(<img.*?>)/gi)[0].match(/src="(.*?)"/)[1]}catch(e){return""}}(n)},this.options.tokens)},e.prototype.getValueForToken=function(t,e){var n=this.getTokenMap(e),i=t.replace(/[\{\}]/g,""),o=n[i];if("undefined"!=typeof o)return"function"==typeof o?o(e,n):o;throw new Error("Unknown token: "+t+", url:"+this.url)},t.fn.rss=function(t,n,i){return new e(this,t,n,i).render(),this}}(jQuery);